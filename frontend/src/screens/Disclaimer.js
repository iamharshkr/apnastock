        ...
        <div className="flex lg:flex-row justify-center items-center">
          <div className="w-screen text-justify">
            ...
            <p>
              ...
              admin@apnastock.com. Our Disclaimer was generated with the help of
              the{" "}
            ...
            <h2>Disclaimers for Apna Stock</h2>

            <p>
              All the information on this website - apnastock.com - is published
              in good faith and for general information purpose only. Apna Stock
              does not make any warranties about the completeness, reliability
              and accuracy of this information. Any action you take upon the
              information you find on this website (Apna Stock), is strictly at
              your own risk. Apna Stock will not be liable for any losses and/or
