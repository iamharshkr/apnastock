      ...
      <div className="container p-2 my-3 text-white">
        <div className="flex lg:flex-row justify-center items-center">
          <div className="w-screen text-justify">
            ...
            <p>Welcome to Apna Stock!</p>

            <p>
              These terms and conditions outline the rules and regulations for
              the use of Apna Stock's Website, located at apnastock.com.
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use Apna Stock if you do not agree
            ...
            <p>
              We employ the use of cookies. By accessing Apna Stock, you agreed
              to use cookies in agreement with the Apna Stock's Privacy Policy.{" "}
            </p>
            ...
            <p>
              Unless otherwise stated, Apna Stock and/or its licensors own the
              intellectual property rights for all material on Apna Stock. All
              intellectual property rights are reserved. You may access this
              from Apna Stock for your own personal use subjected to
              restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from Apna Stock</li>
              <li>Sell, rent or sub-license material from Apna Stock</li>
              <li>Reproduce, duplicate or copy material from Apna Stock</li>
              <li>Redistribute content from Apna Stock</li>
            </ul>
            ...
            <p>
              ...
              Apna Stock does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of Apna Stock,its agents and/or affiliates.
              ...
              laws, Apna Stock shall not be liable for the Comments or for any
            ...
            <p>
              Apna Stock reserves the right to monitor all Comments and to
            ...
            <p>
              You hereby grant Apna Stock a non-exclusive license to use,
            ...
            <p>
              ...
              Apna Stock; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              by sending an e-mail to Apna Stock. Please include your name, your
            ...
            <p>
              No use of Apna Stock's logo or other artwork will be allowed for
